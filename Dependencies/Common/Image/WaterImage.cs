...
-*/
/*调用方法
        //WaterImage Water = new WaterImage();
        //Water.Alpha = 0.6F;
        //Water.Position = ImagePosition.BottomMiddle;
        //Water.SourcePicture = "01.jpg";
        //Water.Words = "Input~版权所有！";
        //WaterImageManage Man = new WaterImageManage();
        //Man.DrawWords( Water.SourcePicture, Water.Words, Water.Alpha, Water.Position, Server.MapPath( "images/" ) );
 */
