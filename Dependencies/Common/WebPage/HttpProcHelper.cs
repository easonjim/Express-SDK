...
namespace ComLib
{
    ...
    public class WebClientHelper
    {
        ...
        /// <param name="errorLenth">错误代码长度</param>
        /// <returns></returns>
        public static string getHtmlContent(string url, Encoding encoding, int errorLenth)
        {
            string Result;
            string getvalue;
            try
            {
                ...
                StreamReader webRstrem = new StreamReader(resStream, encoding);
            ...
            if (getvalue.Length < errorLenth) return null;
        ...
        public static string GetHtmlContentByPost(string url, System.Text.Encoding encoding, Dictionary<string, string> data, System.Web.HttpCookieCollection cookies)
        {
            try
            {
                ...
                if (data != null)
                {
                    ...
                    if (postData.Length > 1) postData.Remove(postData.Length - 1, 1);
                }
                ...
                if (cookies != null)
                {
                    ...
                    if (cookieStr.Length > 1) cookieStr.Remove(cookieStr.Length - 1, 1);
                }
        ...
        public static string GetHtmlContentByPost(string url, System.Text.Encoding encoding, Dictionary<string, string> data)
        {
            return GetHtmlContentByPost(url, encoding, data, null);
        }
    }
