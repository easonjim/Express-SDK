...
namespace ComLib.Parsing
{
    ...
    public class TokenReader : ITokenReader
    {
        ...
        private DictionaryReadOnly<string, string> _readonlyWhiteSpaceMap;
        private DictionaryReadOnly<string, string> _readonlyEolMap;
        ...
        {
            return IsWhiteSpace(_whiteSpaceChars as IDictionary);
        }
        #endregion
