...
namespace ComLib.ValidationSupport
{
    ...
    public static partial class Validation
    {
        ...
        {
            return CheckError(obj1.CompareTo(obj2) == 0, errors, tag, "Objects supplied are not equal");
        }
        ...
        {
            return CheckError(obj1.CompareTo(obj2) != 0, errors, tag, "Objects supplied are equal");
        }
        ...
        public static BoolMessage AreNoneNull(string[] items, string[] itemNames, string errorSuffix, string multilineSeparator)
        {
            ...
            string suffix = string.IsNullOrEmpty(errorSuffix) ? " is not supplied." : errorSuffix;
